        ...
        switch(option)
        {
            	...
            	if (ll_isEmpty(listaServicio) || banderaTexto == 0)
            	{
					...
					if (validacion == 1)
					{
						...
						printf("=========================================================================================\n"
								"||------------------------------< | [DATOS CARGADOS] | >-------------------------------||\n"
								"=========================================================================================\n");
						ll_sort(listaServicio, Servicio_compareById, 1);
						system("pause");
						banderaTexto = 1;
					}
					else
            ...
            case 3:
            	...
            	if(!ll_isEmpty(listaServicio))
            	{
            		animacionCargando();
            		clear();
            		ll_map(listaServicio, calcularPrecioFinal);
            		printf("=========================================================================================\n"
							"||----------------------------< | [TOTALES ASIGNADOS] | >------------------------------||\n"
							"=========================================================================================\n");
            	}
            ...
            case 5:
				...
				if(!ll_isEmpty(listaServicio))
				{
					controller_sortService(listaServicio);
					controller_ListServicio(listaServicio);
				}
				else
				{
            ...
            case 7:
            	if (banderaGuardado == 1)
            	{
            		printf("=========================================================================================\n"
							"||--------------------------------< | [SALIENDO] | >-----------------------------------||\n"
							"=========================================================================================\n");
            		ll_deleteLinkedList(listaServicio);
            	}
            	else
            	{
            		printf("========================================[ERROR]==========================================\n"
